...
test('parseCodexJsonl handles usage correctly', () => {
  ...
  assert.deepEqual(usageFields(usage), { input_tokens: 81011, cached_input_tokens: 60672, output_tokens: 464, reasoning_tokens: 216, total_tokens: 81475, measurement_type: 'exact', source: 'codex.exec.jsonl' });
  ...
  assert.deepEqual(usageFields(providerTotal), { input_tokens: 100, cached_input_tokens: null, output_tokens: 50, reasoning_tokens: null, total_tokens: 150, measurement_type: 'exact', source: 'codex.exec.jsonl' });
  ...
  assert.deepEqual(usageFields(missingOutput), { input_tokens: 100, cached_input_tokens: null, output_tokens: null, reasoning_tokens: null, total_tokens: null, measurement_type: 'exact', source: 'codex.exec.jsonl' });
  ...
  assert.deepEqual(usageFields(reasoningBreakdown), { input_tokens: 100, cached_input_tokens: null, output_tokens: 50, reasoning_tokens: 10, total_tokens: 150, measurement_type: 'exact', source: 'codex.exec.jsonl' });
  ...
  assert.deepEqual(usageFields(multiTurn), { input_tokens: 20, cached_input_tokens: null, output_tokens: 10, reasoning_tokens: null, total_tokens: 30, measurement_type: 'estimated', source: 'codex.exec.jsonl' });
  ...
  assert.deepEqual(usageFields(repeatedShape), { input_tokens: 20, cached_input_tokens: null, output_tokens: 10, reasoning_tokens: null, total_tokens: 30, measurement_type: 'estimated', source: 'codex.exec.jsonl' });
  ...
  assert.deepEqual(usageFields(noIdMulti), { input_tokens: 30, cached_input_tokens: null, output_tokens: 15, reasoning_tokens: null, total_tokens: 45, measurement_type: 'estimated', source: 'codex.exec.jsonl' });
  // Malformed line
