...
- The repository has no persisted project-level `ACTIVE_PIPELINE.md`; this canonical status plus §49 of `MASTER_BLUEPRINT_CANONICAL.md` remain the project progress sources. Overall Maestri program completion is not measured by the MCG 4/7 denominator.
