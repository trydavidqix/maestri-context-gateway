...
- Validation (2026-09-24): MCG `pnpm test` 47/47; syntax/import smoke 33 modules; sensitive scan PASS (125 files); Local Runtime tests 14/14 and typecheck pass; Core/Cloud Fabric strict typecheck passes and tests 69/69, with 2 integration tests skipped. No Docker tests were run. Real provider, durable database and full release/browser QA remain pending.
