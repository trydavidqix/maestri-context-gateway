export function parseCodexJsonl(text) {
  ...
  const context_tokens = input_tokens != null && cached_input_tokens != null ? input_tokens + cached_input_tokens : null;
  ...
  const fields = { input_tokens, cached_input_tokens, context_tokens, output_tokens, reasoning_tokens, total_tokens };
